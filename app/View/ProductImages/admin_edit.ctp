<div class="productImages form">
  <?php echo $this->Form->create('ProductImage', array('enctype'=>'multipart/form-data'));?>
  <fieldset>
    <legend><?php echo __('Admin Edit Product Image'); ?></legend>
    <?php
...
<div class="actions">
  ...
  <ul>
    <li>
      <?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProductImage.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProductImage.id'))); ?>
    </li>
    <li>
      <?php echo $this->Html->link(__('List Product Images', true), array('action' => 'index'));?>
    </li>
  </ul>
</div>