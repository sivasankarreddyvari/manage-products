  ...
  <table cellpadding="0" cellspacing="0">
    ...
    foreach ($products as $product):
      ...
      <tr<?php echo $class;?>>
        ...
        <td>
        <?php echo $this->Html->link($product['Category']['category_name'], array('controller' => 'categories', 'action' => 'index', $product['Category']['id'])); ?>
        </td>
        <td>
        <?php echo $this->Html->link($product['SubCategory']['sub_category_name'], array('controller' => 'sub_categories', 'action' => 'index', $product['SubCategory']['id'])); ?>
        </td>
        <td><?php echo $product['Product']['product_name']; ?>&nbsp;</td>
        <td><?php echo $product['Product']['product_desc']; ?>&nbsp;</td>
...
<div class="actions">
  ...
  <ul>
    <li>
      <?php echo $this->Html->link(__('New Product', true), array('action' => 'add')); ?>
    </li>
  </ul>
</div>