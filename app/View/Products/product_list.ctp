  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%">
    ...
    <td valign="top" class="mainRight" id="bodypart2">
      <div class="breadcrumb">
        ...
        &raquo; <?php echo $this->Html->link(__($selectedCategoryName, true), array('controller'=>'products', 'action' => 'category_list', $selectedCategoryId));?>
        ...
        if (count($productList) > 0)
        {
          foreach ($productList as $product)
          {
            ...
            <div class="productHeading">
              <?php echo $this->Html->link(__($productName, true), array('controller'=>'products', 'action' => 'product_details', $productId));?>
            </div>
