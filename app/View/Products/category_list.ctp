            ...
            <td style="width:150px;" valign="top">
              <div class="productImageHolder">
                <div class="productHeading">
                  <?php
                  echo $this->Html->link(__($subCatName, true), array('controller'=>'products', 'action' => 'product_list', $subCatId));
                  ?>
                </div>
                <?php  
                ...
                array('controller'=>'products', 'action' => 'product_list', $subCatId),
                array('escape' => false)
                );
                ?>
              </div>
              <div class="itemCountColor">
                <?php echo $productCount;?> item(s)
              </div>
            </td>
            <td>&nbsp;</td>
            <?php
    ...
    <td valign="top" class="mainRight" id="bodypart2">
      ...
      <div class="userRightPart">
        ...
        <li>
          <div class="productHeading">
          <?php
          echo $this->Html->link(__($productName, true), array('controller'=>'products', 'action' => 'product_details', $productId));
          ?>
          </div>
            ...
            <tr>
              ...
              <td valign="top">
                <p align="justify">
                  ...
                  {
                    $moreLink = $this->Html->link(__(' .........click here to see more', true), array('controller'=>'products', 'action' => 'product_details', $productId));
