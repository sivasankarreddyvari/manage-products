  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%">
    ...
    <td valign="top" class="mainRight" id="bodypart2">
      <div class="breadcrumb">
        <?php echo $this->Html->link(__('Home', true), array('controller'=>'products', 'action' => 'home'));?>
        &raquo; <?php echo $this->Html->link(__($productCatName, true), array('controller'=>'products', 'action' => 'category_list', $productCatId));?>
        &raquo; <?php echo $this->Html->link(__($productSubCatName, true), array('controller'=>'products', 'action' => 'product_list', $productSubCatId));?>
        &raquo; <?php echo $productName;?>
      </div>
...
<script language="JavaScript" type="text/javascript" src="<?php echo HTTP_HOST?>/js/product_details.js"> </script>
<script type="text/javascript" src="<?php echo HTTP_HOST?>/js/slideshow/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="<?php echo HTTP_HOST?>/js/slideshow/jquery.ennui.contentslider.js"></script>