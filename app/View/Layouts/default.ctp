...
<html>
  <head>
    ...
    <?php echo $this->Html->css('style_menu.css'); ?>
    <?php echo $this->Html->css('jquery.ennui.contentslider.css'); ?>
    <script language="JavaScript" type="text/javascript" src="<?php echo HTTP_HOST?>/js/jquery.min.1.7.1.js"> </script>
    <script language="JavaScript" type="text/javascript" src="<?php echo HTTP_HOST?>/js/product_search.js"> </script>
    ...
    <div id="shopfriend">
      ...
      <div id="header">
        <div class="headerWrap">
        	<div class="top_links">
        	  <div style="float:left;"><?php echo __('Welcome Guest!'); ?></div>
        	</div>
        	<table cellpadding="0" cellspacing="0" width="100%" border="0">				
        		<tr>
        			<td class="spacer20"></td>
        			<td align="right" valign="top">
        			<?php echo $this->Form->create('Product',array('action'=>'searchResult')); ?>
