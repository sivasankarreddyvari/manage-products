  ...
  <table cellpadding="0" cellspacing="0">
    ...
    foreach ($subCategories as $subCategory):
      ...
      <tr<?php echo $class;?>>
        ...
        <td>
        <?php echo $this->Html->link($subCategory['Category']['category_name'], array('controller' => 'categories', 'action' => 'index', $subCategory['Category']['id'])); ?>
        </td>
...
<div class="actions">
  ...
  <ul>
    <li>
      <?php echo $this->Html->link(__('New Sub Category', true), array('action' => 'add')); ?>
    </li>
  </ul>
</div>