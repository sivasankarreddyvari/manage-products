<div class="subCategories form">
  <?php echo $this->Form->create('SubCategory', array('enctype'=>'multipart/form-data'));?>
  <fieldset>
...
<div class="actions">
  ...
  <ul>
    <li>
      <?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SubCategory.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SubCategory.id'))); ?>
    </li>
    <li>
      <?php echo $this->Html->link(__('List Sub Categories', true), array('action' => 'index'));?>
    </li>
  </ul>
</div>