...
class SubCategory extends AppModel
{
  ...
  {
     $subCategoryList = $this->find('all', array('fields'=>array('SubCategory.sub_category_name','SubCategory.id','SubCategory.sub_image_name'),'conditions'=>array('SubCategory.category_id '=>$categoryId)));	
